...
@WebServlet(name = "qnaUpdateReply", urlPatterns = { "/customerService/qnaUpdateReply" })
public class QnaUpdateReplyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QnaReply updatedReply = new QnaReply();
		
		updatedReply.setContent(content);
		updatedReply.setNo(board_no);
		
		new QnaBoardService().updateReply(updatedReply);
