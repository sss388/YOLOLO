...
<section>
	...
	<form action="${ path }/program/update" method="POST" enctype="multipart/form-data">
		<input type="text" value="${ param.no }" name="no"  hidden />
		<table class="create_write">
                   <tr>
                        <th>모임명</th>
                        <td><input type="text" name="title" id="title" value="${ program.title }"></td>
                   </tr>
                   ...
                   <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                         <th>모임 시작일</th>
                         <td>
                         <input type="text" name="start_date" id="start_date" placeholder=" YYYY/MM/DD형식으로 작성해주세요." required="required" 
                    ...
                    <tr>
                         <th>모임 종료일</th>
                         <td>
                         <input type="text" name="end_date" id="end_date" placeholder=" YYYY/MM/DD형식으로 작성해주세요." required="required" 
                         pattern="^(19|20)\d\d/(0[1-9]|1[012])/(0[1-9]|[12][0-9]|3[01])$" title=" YYYY/MM/DD형식으로 작성해주세요.">
                         </td>
                    </tr>
                    ...
                    <tr>
	                    <th>상세설명</th>
	                    <td>
	                    	<textarea name="content" id="content" class="editor" cols="70" rows="10" >${ program.content }</textarea>
	                    </td>
                    </tr>
                   ...
                   <tr>
                        <th>포함 사항(선택)</th>
                        <td>
					        <input type="text" name="inclusion" id="inclusion" placeholder=" ','으로 구분해서 넣어주세요." value="${ program.inclusion }">
					        <!--
                   ...
                   <tr>
                        <th>불포함 사항(선택)</th>
                        <td>
					        <input type="text" name="noninclusion" id="noninclusion" placeholder=" ','으로 구분해서 넣어주세요." value="${ program.noninclusion }">
                       		 <!--
                   ...
                   <tr>
                        <th>준비물(선택)</th>
                        <td>
					        <input type="text" name="supplies" id="supplies" placeholder=" ','으로 구분해서 넣어주세요." value="${ program.supplies }">
                        	<!-- 
                   ...
                   <div id="submit_btn">
                        ...
                        <input type="reset"  onclick="location.replace('${path}/program/oneDay')"  value="목록으로">
                   </div>
